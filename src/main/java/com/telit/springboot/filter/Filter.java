...
public class Filter implements Serializable{
	...
	private static final long serialVersionUID = -352874345968852324L;
    ...
    public boolean isEmpty() {
    	if(FilterOperatorEnum.isNull.equals(getOperator()) 
    			|| FilterOperatorEnum.isNotNull.equals(getOperator())
    			|| FilterOperatorEnum.in.equals(getOperator())){
    		return StringUtil.isEmpty(getProperty()) || StringUtil.isEmpty(getOperator());
    	}
    	
        return StringUtil.isEmpty(getProperty()) || StringUtil.isEmpty(getOperator()) 
        		|| StringUtil.isEmpty(getValue());
    }
}
