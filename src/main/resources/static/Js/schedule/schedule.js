...
function initDatagrid() {
    ...
    var columns = [
        [
            ...
            {field: 'classId',title: '所在班级',width: 100,halign: 'center',align: 'center',
                formatter: classFormat},
            {field: 'gradeId',title: '所在年级',width: 100,halign: 'center',align: 'center',
                formatter: gradeFormat},
            {field: 'fileName',title: '文件名称',width:200,halign: 'center',align: 'center'},
            {field: 'createDate',title: '创建时间',width: 150,halign: 'center',align: 'center',
            ...
            {field: 'startDate',title: '开始时间',width: 130,halign: 'center',align: 'center',
                formatter : function(value){
                    if (value != null) {
                        var date = new Date(value);
                        return date.getFullYear() + '-' + (date.getMonth() + 1) + '-'
            ...
            {field: 'endDate',title: '结束时间',width: 130,halign: 'center',align: 'center',
                formatter : function(value){
                    if (value != null) {
                        var date = new Date(value);
                        return date.getFullYear() + '-' + (date.getMonth() + 1) + '-'
            ...
            {field: 'createUser',title: '创建人',width: 150,halign: 'center',align: 'center',formatter: userFormat},
    ...
    var url = '/schedule/getScheduleList';
    $('#data_dg').datagrid({
        url: url,
        height: 'auto',
        method: 'get',
...
function editInfoDo(id) {
    if(!id){
        ...
        var href = '/schedule/openEditView?id='+id;
        var content = '<iframe id="dataIframe" src="' + href + '" width="100%" height="99%" frameborder="0" scrolling="auto"></iframe>';
        $('#data_dialog').dialog({
            title: '编辑',
            width: 1000,
...
function userFormat(value, options, rowObject){
    var teacherName="";
    $.ajax({
        url:  '/vw/getTeacherName',
        data:{
            userId:value
        },
        type:"POST",
